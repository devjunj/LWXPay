...
use Org\Jaden\WxPay\Payment\WxPayFactory;
...
class UnifiedOrder extends DataBase
{
    ...
    {
        $result =  parent::checkParams();
        if($this->values['trade_type'] == WxPayFactory::TRADE_TYPE_JSAPI && !isset($this->values['openid']))
            throw new WxPayException("统一支付接口中，缺少必填参数openid！trade_type为JSAPI时，openid为必填参数！");
        if($this->values['trade_type'] == WxPayFactory::TRADE_TYPE_NATIVE && !isset($this->values['product_id']))
